...
public class StatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusInput=(EditText)findViewById(R.id.satus_input);
        loadingBar=new ProgressDialog(this);
        //Lấy status cũ bỏ sang khi người dùng muốn thay đổi
        String old_status=getIntent().getExtras().getString("user_status").toString();
            ...
            changeStatusRef.child("user_status").setValue(new_status).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task)
                {
                    if(task.isSuccessful())
                        ...
                        {
                            Toast.makeText(StatusActivity.this,"Error Occurred! Please try again",Toast.LENGTH_SHORT).show();
                        }
                }
            });
        }
